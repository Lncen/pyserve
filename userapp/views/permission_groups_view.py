...
from userapp.serializers.permission_serializers import (PermissionGroupSerializer,
                                                        PermissionGroupNameSerializer,
                                                        PermissionSerializer,
                                                        PermissionGroupNameTreeWithPermissionsSerializer)
from common.response import http_OK_response,http_BAD_response



class PermissionGroupNameViewSet(BaseGenericAPIView,viewsets.ModelViewSet):
    """权限分组名称"""
    queryset = PermissionGroupName.objects.all()
    serializer_class = PermissionGroupNameSerializer

class PermissionGroupViewSet(BaseGenericAPIView,viewsets.ModelViewSet):
    """权限分组"""
